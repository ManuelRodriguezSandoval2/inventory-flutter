...
class LoginController extends GetxController {
  ...
  iniciarSesion() async {
    await LoginApi.instance
      ...
      Get.snackbar("¡Atención!", "Usuario o contraseña inválidos", 
          colorText: Colors.black, backgroundColor: Colors.deepOrange[300], padding: const EdgeInsets.all(40.0, ),
          margin: EdgeInsets.fromLTRB(0, 0, 0, 75), snackPosition: SnackPosition.BOTTOM, overlayColor: Colors.green );
